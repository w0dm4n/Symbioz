...
public CharacterToRemodelInformations(uint id, string name, sbyte breed, bool sex, ushort cosmeticId, IEnumerable<int> colors, sbyte possibleChangeMask, sbyte mandatoryChangeMask)
