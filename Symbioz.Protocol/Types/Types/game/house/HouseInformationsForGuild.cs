...
public HouseInformationsForGuild(uint houseId, uint modelId, string ownerName, short worldX, short worldY, int mapId, ushort subAreaId, IEnumerable<int> skillListIds, uint guildshareParams)
        {
