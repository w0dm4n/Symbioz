    ...
    public class FighterStats
    {
        ...
        public GameFightMinimalStats GetMinimalStats()
        {
            return new GameFightMinimalStats((uint)Stats.LifePoints,(uint)RealStats.LifePoints, (uint)(RealStats.LifePoints + ErodedLife), (uint)Stats.AllDamagesBonus,
                (uint)ShieldPoints, Stats.ActionPoints > 12 ? (short)12 : Stats.ActionPoints, Stats.ActionPoints > 12 ? (short)12 : Stats.ActionPoints, Stats.MovementPoints > 6 ? (short)6 : Stats.MovementPoints, Stats.MovementPoints > 6 ? (short)6 : Stats.MovementPoints,
