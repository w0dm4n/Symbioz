...
namespace Symbioz.Providers.ActorIA.Actions
{
    ...
    /// Author GyGy19
    /// </summary>
    [IAAction(IAActionsEnum.CastDiagonalAction)]
    class CastDiagonalAction : AbstractIAAction
    {
        ...
        public override void Execute(MonsterFighter fighter)
        {
            try
            {
                ...
                Fighter lower = fighter.GetOposedTeam().LowerProchDiagonalFighter(fighter, po);
                if (lower == null)
                    return;
